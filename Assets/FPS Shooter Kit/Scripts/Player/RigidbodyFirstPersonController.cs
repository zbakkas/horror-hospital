...
namespace UnityStandardAssets.Characters.FirstPerson
{
	...
	{
		//public AnimatorClass playerAnimContr;
		...
		private void Update ()
		{
			if (playerHealth.health > 0) {
				...
				if (CrossPlatformInputManager.GetButtonDown ("Jump") && !m_Jump && PlayerPosition.PlayerPosition != BehaviorList.PlayerBehavior.Sit) {
					m_Jump = true;
				}
			}
		}
		...
		private void FixedUpdate ()
		{
			if (playerHealth.health > 0) {
				...
				speedCur = m_RigidBody.velocity.sqrMagnitude;
