...
public class flomov : MonoBehaviour
{
    //TAJWAL
    ...
    void Start()
    {
        ...
        pos = new Transform[12];
        pos[0] = GameObject.Find("R (1)").transform;
        pos[1] = GameObject.Find("R (2)").transform;
        pos[2] = GameObject.Find("R (3)").transform;
        pos[3] = GameObject.Find("R (4)").transform;
        pos[4] = GameObject.Find("R (5)").transform;
        pos[5] = GameObject.Find("R (6)").transform;
        pos[6] = GameObject.Find("R (7)").transform;
        pos[7] = GameObject.Find("R (8)").transform;
        pos[8] = GameObject.Find("R (9)").transform;
        pos[9] = GameObject.Find("R (10)").transform;
        pos[10] = GameObject.Find("R (11)").transform;
        pos[11] = GameObject.Find("R (12)").transform;
